  ...
  render() {
    return (
      <div className="nav-container">
        <div className="nav">
          <div className="logos">
            <div className="logo vocativ-films"><a href="http://www.vocativ.com/" target="_blank" onClick={createEventTracker('vocativ-nav-btn')}><img src="/darknet/images/vocativ-films-logo.svg" /></a></div>
            <div className="logo darknet"><a href="/darknet"><img src="/darknet/images/darknet-logo.svg" /></a></div>
          </div>
